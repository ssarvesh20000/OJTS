  ...
  return (
    <section id="services" className="services-section">
      ...
      <AttachMoneyIcon style={{ fontSize: 40, color: '#000' }} /> 
        ...
        <p style={{ color: 'black' }}>A crystal clear, ceramic window film that blocks out heat and harmful UV rays; perfect for
           those who are looking to gain the benefits of a premium window film without altering the 
           appearance of their vehicle</p>
      </div>
      ...
      <AttachMoneyIcon style={{ fontSize: 40, color: '#000' }} /> 
        ...
        <p style={{ color: 'black' }}>For a more premium option, Autobahn’s Black Ceramic Film offers the same benefits as the previous
      ...
      <AttachMoneyIcon style={{ fontSize: 40, color: '#000' }} /> 
        ...
        <p style={{ color: 'black' }}>For those looking for the highest level of protection and performance in a film, the Ceramic i3 
          provides the most advanced capacity of all the performance benefits. Not only that, but it is the 
          most durable of all the films thanks to its multi-ceramic layer and thick deep dye construction. </p>
      </div>
    </section>
  );
}
